  ...
  return (
    <div className={classes.experience}>
      ...
      <div className={classes.experience__jobBox1}>
        ...
        <ul>
          <li>
            ...
            which required integration with Craco, modification of JEST tests
            and CI/CD pipeline
          </li>
          <li>
          ...
          <li>
            Optimization of NodeJS and ReactJS application, which were deployed
      ...
      <div className={classes.experience__jobBox2}>
        ...
        <ul>
          <li>
            Volunteer for CYF, a non-profit organisation that trains refugees
            and disadvantaged people to become web developers and helps them to
            find work in the tech industry
          </li>
          <li>
          ...
          <li>
            Main technologies include: Html, CSS, JavaScript, PostgreSQL,
            ReactJS, Express.js
          </li>
        </ul>
      </div>
      ...
      <div className={classes.experience__jobBox3}>
        ...
        <ul>
          ...
          <li>
            Support includes but is not limited to solving technical problems
            and answering non-technical questions related to the IT sector.
          </li>
          <li>
            Main technologies include: Html, CSS, JavaScript, PostgreSQL,
            ReactJS, Express.js
      ...
      <div className={classes.experience__jobBox4}>
        ...
        <ul>
          ...
          <li>
            Studying and practising many new and difficult concepts, which
            proved that I can work under the stress and I am quick learner
          </li>
          <li>
            Working within a small development team to design and build an
            on-line quote application using React, SASS, Express and Postgress
          </li>
        </ul>
      </div>
    </div>
